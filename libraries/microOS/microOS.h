...
// Switch to either use gpiox (12 floats) or gpio (8 floats, 4 ints) messages
#define MICROOS_USE_GPIOX // comment out or #undef to use gpio messages
  ...
  #define MICROOS_GPIO_FLOATS          4
  #define MICROOS_GPIO_INTS            2
  #define MICROOS_NOPRINT
  //#define MICROOS_NOPRINTBUFFER
#else
  #define MICROOS_PRINT_BUFFER_SIZE  128
  #ifdef MICROOS_USE_GPIOX
    #define MICROOS_GPIO_FLOATS       12
    #define MICROOS_GPIO_INTS          0
  #else
    #define MICROOS_GPIO_FLOATS        8
    #define MICROOS_GPIO_INTS          4
  #endif
#endif
...
private:
  ...
  float _gpin_float[MICROOS_GPIO_FLOATS];
  int32_t _gpin_int[MICROOS_GPIO_INTS];
  float _gpout_float[MICROOS_GPIO_FLOATS];
  int32_t _gpout_int[MICROOS_GPIO_INTS];
