...
if isfile(csvfile_flat)
    ...
    % Wheel A
    figure;
    plot(t_flat, ref_flat, 'g--', 'LineWidth', 1.2); hold on;
    plot(t_flat, speedA_flat, 'b', 'LineWidth', 1.2);
    plot(t_flat, sim_flat, 'r', 'LineWidth', 1.2);
    ...
    figure;
    plot(t_flat, errorA_flat, 'b', 'LineWidth', 1.2); hold on;
    plot(t_flat, sim_err_flat, 'r--', 'LineWidth', 1.2);
    ...
    figure;
    plot(t_flat, ctrlA_flat, 'b', 'LineWidth', 1.2); hold on;
    plot(t_flat, sim_ctrl_flat, 'r--', 'LineWidth', 1.2);
    legend('Measured', 'Simulated', 'Location', 'southeast');
...
if isfile(csvfile_incline)
    ...
    % Wheel A
    figure;
    plot(t_inc, ref_inc, 'g--', 'LineWidth', 1.2); hold on;
    plot(t_inc, speedA_inc, 'b', 'LineWidth', 1.2);
    plot(t_inc, sim_inc, 'r', 'LineWidth', 1.2);
    legend('Reference', 'Measured', 'Simulated', 'Location', 'southeast');
    title('Incline (nominal) - Wheel A closed-loop'); xlabel('Time [s]'); ylabel('Velocity [rad/s]'); grid on;

    figure;
    plot(t_inc, errorA_inc, 'b', 'LineWidth', 1.2); hold on;
    plot(t_inc, sim_err_inc, 'r--', 'LineWidth', 1.2);
    legend('Measured', 'Simulated', 'Location', 'southeast');
    title('Incline (nominal) - Wheel A tracking error'); xlabel('Time [s]'); ylabel('Error [rad/s]'); grid on;

    figure;
    plot(t_inc, ctrlA_inc, 'b', 'LineWidth', 1.2); hold on;
    plot(t_inc, sim_ctrl_inc, 'r--', 'LineWidth', 1.2);
    legend('Measured', 'Simulated', 'Location', 'southeast');
...
if isfile(csvfile_incline) && isfile(csvfile_incline_low)
    ...
    figure;
    plot(t_inc, speedA_inc, 'b', 'LineWidth', 1.2); hold on;
    plot(t_low, speedA_low, 'Color', [0.8 0.4 0], 'LineWidth', 1.2);
    plot(t_inc, sim_inc_nom, 'b--', 'LineWidth', 1);
    plot(t_low, sim_inc_low, '--', 'Color', [0.8 0.4 0], 'LineWidth', 1);
    ...
    figure;
    plot(t_inc, errorA_inc, 'b', 'LineWidth', 1.2); hold on;
    plot(t_low, errorA_low, 'Color', [0.8 0.4 0], 'LineWidth', 1.2);
    plot(t_inc, sim_err_nom, 'b--', 'LineWidth', 1);
    plot(t_low, sim_err_low, '--', 'Color', [0.8 0.4 0], 'LineWidth', 1);
    legend('Nominal (meas)', 'Low-BW (meas)', 'Nominal (sim)', 'Low-BW (sim)', 'Location', 'southeast');
    ...
    figure;
    plot(t_inc, ctrlA_inc, 'b', 'LineWidth', 1.2); hold on;
    plot(t_low, ctrlA_low, 'Color', [0.8 0.4 0], 'LineWidth', 1.2);
    plot(t_inc, sim_ctrl_nom, 'b--', 'LineWidth', 1);
    plot(t_low, sim_ctrl_low, '--', 'Color', [0.8 0.4 0], 'LineWidth', 1);
    legend('Nominal (meas)', 'Low-BW (meas)', 'Nominal (sim)', 'Low-BW (sim)', 'Location', 'southeast');
    title('Incline comparison - Wheel A control signal'); xlabel('Time [s]'); ylabel('Voltage [V]'); grid on;

    % Wheel B - closed-loop comparison
    figure;
    plot(t_inc, speedB_inc, 'b', 'LineWidth', 1.2); hold on;
    plot(t_low, speedB_low, 'Color', [0.8 0.4 0], 'LineWidth', 1.2);
    plot(t_inc, sim_inc_nom, 'b--', 'LineWidth', 1);
    plot(t_low, sim_inc_low, '--', 'Color', [0.8 0.4 0], 'LineWidth', 1);
    legend('Nominal (meas)', 'Low-BW (meas)', 'Nominal (sim)', 'Low-BW (sim)', 'Location', 'southeast');
    ...
    figure;
    plot(t_inc, errorB_inc, 'b', 'LineWidth', 1.2); hold on;
    plot(t_low, errorB_low, 'Color', [0.8 0.4 0], 'LineWidth', 1.2);
    plot(t_inc, sim_err_nom, 'b--', 'LineWidth', 1);
    plot(t_low, sim_err_low, '--', 'Color', [0.8 0.4 0], 'LineWidth', 1);
    legend('Nominal (meas)', 'Low-BW (meas)', 'Nominal (sim)', 'Low-BW (sim)', 'Location', 'southeast');
    ...
    figure;
    plot(t_inc, ctrlB_inc, 'b', 'LineWidth', 1.2); hold on;
    plot(t_low, ctrlB_low, 'Color', [0.8 0.4 0], 'LineWidth', 1.2);
    plot(t_inc, sim_ctrl_nom, 'b--', 'LineWidth', 1);
    plot(t_low, sim_ctrl_low, '--', 'Color', [0.8 0.4 0], 'LineWidth', 1);
    legend('Nominal (meas)', 'Low-BW (meas)', 'Nominal (sim)', 'Low-BW (sim)', 'Location', 'southeast');
