...
Table~\ref{tab:K_poles} and Figure~\ref{fig:step_K_sweep} confirm that larger $K$ moves $z_\text{cl}$ toward zero, yielding faster settling but higher control effort. For $K > K_\text{max}$, the pole exits the unit circle and the system becomes unstable.
