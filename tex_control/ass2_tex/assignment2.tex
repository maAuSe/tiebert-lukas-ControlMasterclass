...
\end{figure}
\noindent Figure \ref{fig:Uncompensated-Bode} shows the Bode diagram of the uncompensated open-loop system $G_s(s)$, both for motor A and motor B. 
...
The closed-loop bandwidth $\omega_{BW}$ cannot exceed the frequency where the total open-loop phase $\phi_L$ approaches -180°. 
