...
\begin{document}
	...
	Figures~\ref{fig:measured_vs_modeled} and \ref{fig:measured_vs_modeled_simplified} show the measured angular velocity compared with the simulated responses for both models, zoomed to clearly reveal differences during transient periods. Figures~\ref{fig:model_error} and \ref{fig:model_error_simplified} display the error (difference) between measurement and simulation for each model.
	
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.7\linewidth]{images/measured_vs_modeled_nofilter.png}
		\caption{Measured vs simulated response (third-order model, zoomed)}
		\label{fig:measured_vs_modeled}
	\end{figure}
	
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.7\linewidth]{images/measured_vs_modeled_nofilter_simplified.png}
		\caption{Measured vs simulated response (simplified second-order model, zoomed)}
		\label{fig:measured_vs_modeled_simplified}
	\end{figure}
	
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.7\linewidth]{images/model_vs_meas_error_nofilter.png}
		\caption{Prediction error: measurement minus simulation (third-order model)}
		\label{fig:model_error}
	\end{figure}
	
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.7\linewidth]{images/model_vs_meas_error_nofilter_simplified.png}
		\caption{Prediction error: measurement minus simulation (simplified model)}
		\label{fig:model_error_simplified}
	\end{figure}
