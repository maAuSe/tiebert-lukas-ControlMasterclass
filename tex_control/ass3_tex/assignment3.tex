...
\begin{document}
  ...
  The estimator and controller run together. The estimator pole is placed ten times slower than the controller: $(1-p_\text{est}) = (1-p_\text{cl})/10$, leading to $L_\text{slow} \approx -0.004$ for $K_\text{nom}$. Two experiments are executed with a 0.15~m step:
  \begin{enumerate}
